...
<%
	...
	<div id="main">
		<div id="register">
			<form action="${app_path }/userlistmvc/updatepwd.do" method="post">			
				<input class="information" name="userphone" id="p1" placeholder="  手机号" onblur="getCode()" /><br/>
				<input class="information2" name="code" placeholder="  验证码" /><input class="information3" type="button" id="getcode" style="cursor: pointer;" value="获取验证码"/><br />
				<input class="information" type="password" name="userpwd" placeholder="  新密码" /><br /> 
				<input type="submit" value="修改密码" class="register"/>
			</form>
		</div>
		<div id="foot">
